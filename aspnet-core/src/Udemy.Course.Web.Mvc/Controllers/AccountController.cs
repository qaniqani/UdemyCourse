...
using Udemy.Course.Sessions;
using Udemy.Course.Web.Models.Account;
using Udemy.Course.Web.Views.Shared.Components.TenantChange;

namespace Udemy.Course.Web.Controllers
{
    public class AccountController : CourseControllerBase
    {
