...
{
    public abstract class CourseWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CourseWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CourseWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CourseDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CourseDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CourseDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CourseDbContext, Task<T>> func)
        {
            T result;
